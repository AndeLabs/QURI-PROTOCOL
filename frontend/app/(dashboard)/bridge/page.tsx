                  ...
                  <>
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      ...
                      <div className="bg-cyan-50 border border-cyan-200 rounded-xl p-4">
                        ...
                        <p className="font-mono font-bold text-xl text-cyan-900">
                    ...
                    <div className="space-y-2">
                      ...
                      <div className="relative">
                        <input
                          ...
                          placeholder="0.0"
                          className="w-full px-4 py-3 pr-20 border border-museum-light-gray rounded-xl focus:outline-none focus:ring-2 focus:ring-gold-500 font-mono"
                        />
                        <button
                          onClick={() => {
