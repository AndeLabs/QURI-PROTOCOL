      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="space-y-8">
          ...
          <div className="flex items-center justify-between">
            ...
            <Link
              href="/dashboard"
              className="inline-flex items-center gap-2 text-sm font-medium text-museum-dark-gray hover:text-gold-600 transition-colors"
            >
              Go to Dashboard
          ...
          {!isConnected ? (
            <div className="border-2 border-dashed border-museum-light-gray rounded-2xl p-12 text-center">
              ...
              <p className="text-museum-dark-gray mb-8 max-w-md mx-auto">
                Connect with Internet Identity to view your balances and manage your Bitcoin
                Runes
              </p>
